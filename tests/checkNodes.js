...
const data = require('../zentcash-nodes.json')
...
function checkTestNode (node) {
  ...
  return request({ url: 'https://raw.githubusercontent.com/ZentCashFoundation/zentcash-nodes-json/master/zentcash-nodes.json', json: true })
    .then(data => {
